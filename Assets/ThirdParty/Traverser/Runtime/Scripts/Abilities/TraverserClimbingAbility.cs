...
namespace Traverser
{
    ...
    public class TraverserClimbingAbility : MonoBehaviour, TraverserAbility
    {
        ...
        public TraverserAbility OnUpdate(float deltaTime)
        {
            ...
            if (ledgeDetected && animationController.spineRig != null)
            {
                ...
                if (moveIntensity > 0.1f && animationController.aimRigEffector != null)
            ...
            else if (animationController.spineRig != null)
            {
                animationController.spineRig.weight = Mathf.Lerp(animationController.spineRig.weight, 0.0f, bodyAimIKSpeed * Time.deltaTime);

                if (animationController.spineRig.weight < 0.1f && animationController.aimRigEffector != null)
